...
proc create_root_design { parentCell } {
  ...
  set adc_clk_n_o [ create_bd_port -dir O adc_clk_n_o ]
  set adc_clk_p_i [ create_bd_port -dir I adc_clk_p_i ]
  set adc_clk_p_o [ create_bd_port -dir O adc_clk_p_o ]
  ...
  set vinn_i [ create_bd_port -dir I -from 4 -to 0 vinn_i ]
  set vinp_i [ create_bd_port -dir I -from 4 -to 0 vinp_i ]
  ...
  connect_bd_net -net processing_system7_FCLK_CLK0 [get_bd_pins processing_system7/FCLK_CLK0] [get_bd_pins processing_system7/M_AXI_GP0_ACLK]
