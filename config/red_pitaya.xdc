...
# Output ADC clock, can only be used after some soldering 
set_property IOSTANDARD LVCMOS18 [get_ports adc_clk_*_o]
set_property SLEW       FAST     [get_ports adc_clk_*_o]
set_property DRIVE      8        [get_ports adc_clk_*_o]
